...
// [ASSUMPTION] see CommitStory-Schema-Spec-v1.0.md §2.4 — not an upstream-locked entity/state.
...
export const publicationFailureReasonEnum = pgEnum("publication_failure_reason", [
